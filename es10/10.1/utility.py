...
def create_temp_ini(layout:str,ncities:int,box:float,metric:str,iters:int,ntemp:int,beta_step:float,db_name:str):
...
class Container:
    ...
    def get_fitness(self):
        ...
        cur = conn.cursor()
        res = cur.execute("SELECT * FROM FITNESSES")
        return list(res)
...
class DatabaseHandler():
    ...
    def __init__(self,*args,**kwargs):
        ...
        if len(args)>0:
            ...
            valids = ["NCITIES","LAYOUT","BOX","METRIC","NTEMP","BETA_STEP","ITERATIONS"]
            self.settings = {}
        ...
        self.output_dir = f"./10.1/outputs/{layout}/"
